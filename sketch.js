...
var organicManureTransparent,crop,pesticideTransparent;
var ground;
...
function draw() 
{
 ...
 if(gameState === 0)
 {
	stroke("yellow");
	textSize(70);
	text("Welcome to the agroGame",350,400);
	text("Press space to start the game ",450,500);
  }
...
//start
  ...
  if(gameState === 1)
  {
	...
	textSize(70);
	text("step1 : start with ploughing the land",200,400);
  }
...
if(gameState === 2)
{
	...
	if(plough.isTouching(ground))
	{
		...
		textSize(70);
		stroke("black");
		text("step2 : sow the seeds",350,400);
	}
}
	...
	if(gameState === 3)
{
	...
	if(mousePressedOver(seeds))
	{
	 ...
	 if(seeds.isTouching(ground))
	 {
		...
		textSize(70);
		stroke("black");
		text("step3 : adding manure or fertiliser",350,400);
  }
}
	...
	if(fertilisers.isTouching(ground) || organicManure.isTouching(ground))
	 {
		...
		text("step4 : irrigate your land with water",350,400);
	 }
}
...
if(gameState === 6)
{
  ...
  crop.scale = 0.2;
   ...
   text(" step5 : add pesticides to protect your crop ",350,400);
}
...
if(mousePressedOver(pesticides))
{
	...
	if(pesticides.isTouching(ground))
 {
		...
		textSize(70);
 		stroke("black");
		text("great!!",250,300);
 		text(" step6 : supply enough water and wait for the yeild",350,400);
 		water.x = 1650;
 		water.y = 160;
 		water.visible = true;
	  }
	...
	stroke("black");
	text("few days later...",350,300);
	text("press up arrow to continue",350,400);
	  }
